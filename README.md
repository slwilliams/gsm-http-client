...
The test sketch shows the main functionality of the libary - it can send data via POST or GET. The GET request uses the variable data for the data being transmitted i.e. the url sent is: http://108.174.49.28/test.php?data=1234 Both POST and GET methods have a data length limit of 900 characters.
